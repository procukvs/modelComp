...
public class PnCommand extends JPanel {
	...
	//ShowRule(ShowCommand owner) {         //     !!!!!!ref!!!!!!!!!!!!!!!!!!
	PnCommand(){                             //     !!!!!!ref!!!!!!!!!!!!!!!!!!
		//showCommand = owner;              //     !!!!!!ref!!!!!!!!!!!!!!!!!!
	...
	class LsState implements ActionListener  {
		public void actionPerformed(ActionEvent event){
			...
			case "Post":
				...
				} else JOptionPane.showMessageDialog(PnCommand.this,  StringWork.transferToArray(mes));
				break;
			case "Computer":
	...
	class LsMove implements ActionListener  {
		public void actionPerformed(ActionEvent e) {
			...
			else JOptionPane.showMessageDialog(PnCommand.this, text);	
